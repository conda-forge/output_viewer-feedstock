About output_viewer-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/output_viewer-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3173&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/output_viewer-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
mamba repoquery search output_viewer --channel conda-forge

# List packages depending on `output_viewer`:
mamba repoquery whoneeds output_viewer --channel conda-forge
